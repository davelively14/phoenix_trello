...
const Actions = {
  fetchBoards: () => {
    return dispatch => {
      ...
      // Dispatches BOARDS_FETCHING, which will set a 'fetching' prop so that
      // the HomeIndexView knows to display the spinners.
      dispatch({ type: Constants.BOARDS_FETCHING })

      // Retrieve the boards. Once we get it back,
